...
class NewsIndexCustomAdapter(private val newsIndexItem: NewsIndexItem, private val context: Context)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        newsIndexAdapterUtility.moveUserToStoryPageOnClick(holder, context)
    }
